 ...
 *   GLOBAL FUNCTIONS
 **********************/
extern int d51e5ta7601_driver_init(void);
extern int d51e5ta7601_video_flush(int xs, int ys, int xe, int ye, void *data, size_t len);
...
#define MY_DISP_BUF_SIZE (MY_DISP_HOR_RES * 240)
...
static void disp_flush(lv_disp_drv_t * disp_drv, const lv_area_t * area, lv_color_t * color_p)
{
    if(disp_flush_enabled) {
        ...
        d51e5ta7601_video_flush(area->x1,
                                area->y1,
                                area->x2,
                                area->y2,
                                (void *)color_p,
